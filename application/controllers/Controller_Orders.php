...
defined('BASEPATH') OR exit('Прямой доступ к сценарию запрещен');
	...
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if($value['paid_status'] == 1) {
				$paid_status = '<span class="label label-success">Оплаченный</span>';	
			}
			else {
				$paid_status = '<span class="label label-warning">Не выплачивается</span>';
			}
	...
	public function remove()
	{
        ...
        if($order_id) {
            ...
            if($delete == true) {
                ...
                $response['messages'] = "Ошибка to базе данных при удалении информации о продукте";
            }
        }
        else {
            $response['success'] = false;
			  ...
			  <section class="invoice">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        ...
			        <b>Идентификатор счета:</b> '.$order_data['bill_no'].'<br>
			        <b>Name:</b> '.$order_data['customer_name'].'<br>
			        <b>Адрес:</b> '.$order_data['customer_address'].' <br />
			        <b>Phone number:</b> '.$order_data['customer_phone'].'
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
			    ...
			    <div class="row">
			      ...
			      <div class="col-xs-6 pull pull-right">
			        ...
			        <div class="table-responsive">
			          <table class="table">
			            <tr>
			              <th style="width:50%">Сумма брутто:</th>
