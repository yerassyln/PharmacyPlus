      ...
      <form role="form" action="<?php echo base_url('Controller_Category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Name of category</label>
            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Type name of category" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Controller_Category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Name of category</label>
            <input type="text" class="form-control" id="edit_category_name" name="edit_category_name" placeholder="Type name of category" autocomplete="off">
          </div>
          <div class="form-group">
