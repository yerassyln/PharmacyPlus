      ...
      <form role="form" action="<?php echo base_url('Controller_Warehouse/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Name of warehouse</label>
            <input type="text" class="form-control" id="store_name" name="store_name" placeholder="Enter the name of warehouse" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Controller_Warehouse/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Name of warehouse</label>
            <input type="text" class="form-control" id="edit_store_name" name="edit_store_name" placeholder="Enter the name of warehouse" autocomplete="off">
          </div>
          <div class="form-group">
