    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">Add destination group</button>
          <br /> <br />
        <?php endif; ?>
      ...
      <form role="form" action="<?php echo base_url('Controller_Items/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Enter the name of element" autocomplete="off">
          </div>
          <div class="form-group">
      ...
      <form role="form" action="<?php echo base_url('Controller_Items/update') ?>" method="post" id="updateBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="edit_brand_name" name="edit_brand_name" placeholder="Enter the name of element" autocomplete="off">
          </div>
          <div class="form-group">
