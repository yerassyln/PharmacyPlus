          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price" name="price" placeholder="Enter the price" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="qty">Quantity</label>
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Enter the quantity" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="description">Description</label>
                  <textarea type="text" class="form-control" id="description" name="description" placeholder="Enter the description" autocomplete="off">
                  </textarea>
                </div>
                ...
                <div class="form-group">
                  <label for="brands">Destination</label>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var btnCust = '<button type="button" class="btn btn-secondary" title="Add Image Tags" ' + 
        'onclick="alert(\'Your custom code is here.\')">' +
