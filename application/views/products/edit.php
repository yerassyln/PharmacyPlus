        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="product_image">Refresh Image</label>
                  <div class="kv-avatar">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter the name of product" value="<?php echo $product_data['name']; ?>"  autocomplete="off"/>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="qty" name="qty" placeholder="Введите кол-во" value="<?php echo $product_data['qty']; ?>" autocomplete="off" />
                </div>
